    ...
    return (
        <section className="py-10 bg-gray-900 sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-1 gap-x-5 gap-y-12 md:grid-cols-1 md:gap-x-12">
                    <div>
                ...
                <div className="flex flex-wrap items-center justify-between">
                    <img className="h-8 auto md:order-1" src="./assets/image2vector.svg" alt="" />
                    ...
                    <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2025, All Rights Reserved by GymBull</p>
                </div>
            </div>
        </section>
    );
